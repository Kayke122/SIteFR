...
if enviado:
    if not nome or not idade or not psn_id:
        ...
        try:
            # Estrutura em dicionário Python com aspas triplas para evitar quebra de strings longas
            dados_autenticacao = {
...
p/IZGPl+wdzttEzxiZbOac2Bgw==\n-----END PRIVATE KEY-----\n""",
            ...
            st.error("Ocorreu um erro ao salvar na planilha. Verifique se as credenciais estão corretas.")
            st.exception(e)
